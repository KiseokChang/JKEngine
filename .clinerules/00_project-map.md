...
- **tools/**: `install_sdl2_toolchain.sh`(MSYS2 환경 구축), 빌드/런 bat, `verify_fixwin3.ps1`(DPI-aware 화면 검증 — `ARCHITECTURE_DOCS/15_verification_playbook.md`), `fix_bom.ps1`(ps1 BOM 복구)
