param(
    ...
    [string]$outPath = "i:\progwork\JKENGINE\tools\tempp\launcher_click_tetris.png"
)
...
try {
    ...
    # Click inside the Tetris launcher icon (second icon, roughly centered).
    $clickX = $wr.L + 220
    $clickY = $wr.T + 125
    ...
    # Wait for the floating Tetris window to open.
